...
const DEFAULT_FOOTER = {
  logoText: 'TechFlow',
  companyDescription:
    'Empowering startups and enterprises with cutting-edge web development solutions. Join thousands of developers building the future with our modern platform and innovative tools.',
  contactEmail: 'hello@techflow.dev',
  ...
  madeWithText: 'with ❤️ by TechFlow',
  socialText: 'Connect:',
